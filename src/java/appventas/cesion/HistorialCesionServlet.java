...
public class HistorialCesionServlet extends HttpServlet{
@Override
public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
     if(request.getSession(true).getAttribute("loginauth")==null){
      ...
      getServletConfig().getServletContext().getRequestDispatcher("/cesionview/search.jsp").forward(request,response);
...
public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
   ...
   request.getSession().setAttribute("botonera","yes");
    ...
    try {
       ...
       float auxnropaginas;
       int nropaginas; 
       ArrayList<Object[]> arraycesion;
       nroregistros = objCesionModel.conteoCesion(fechadesde, fechahasta, empresaid);  
       ...
       nropaginas =(int) Math.ceil(auxnropaginas);
         ...
         switch (acc){
          ...
          case "BUSCAR":    
                        nroregistros = objCesionModel.conteoCesion(fechadesde, fechahasta, empresaid);
                        arraycesion = objCesionModel.listFecha(fechadesde, fechahasta, empresaid,indice);
                       ...
                       getServletConfig().getServletContext().getRequestDispatcher("/cesionview/listacesion.jsp").forward(request,response);
                      } 
        ...
        Logger.getLogger(HistorialCesionServlet.class.getName()).log(Level.SEVERE, null, ex);
